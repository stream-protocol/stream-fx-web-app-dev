  ...
  return (
    <div className={styles.container}>
      ...
      <button
        ...
        onClick={() => {
          window.open(`
            https://x.com/intent/tweet?text=Reserved%20my%20gateway%20to%20Web3%20with%20%40WagmiBio%20LFG!&url=https%3A%2F%2Fstreampayment.app%2F${props.link}
          `, '_blank');
        }}
      >
        Share on X
