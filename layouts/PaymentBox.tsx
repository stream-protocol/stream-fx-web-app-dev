        ...
        <div>
          ...
          <form onSubmit={(e) => {
            ...
            <div className={homeStyles.inputParent}>
              <label htmlFor="urlInput">streampayment.app/</label>
                ...
                <div className={styles.profile}>
                  ...
                  <div className={styles.nameAndDescp}>
                    ...
                    <p className={styles.description}>
                      {props.user.description ? props.user.description : `Hi, I'm ${props.user.name ? props.user.name : 'a wagmi user'} and this is my StreamPayment link.`}
                    </p>
                  </div>
                </div>
