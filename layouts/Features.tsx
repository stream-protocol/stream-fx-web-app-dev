...
const sections = [
  ...
  },
  {
    'features': [{
      ...
      description: "Embed streampayment.app on any website with a single line of code."
    }]
  },
  {
    'features': [{
      ...
      icon: international,
      title: "International",
      description: "streampayment.app is the fastest way to receive payments from anyone internationally."
    }]
  }
]
