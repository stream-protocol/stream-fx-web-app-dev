...
import love from "@/images/emojis/wlove.png"
import wallet from "@/images/emojis/wallet.png"
import stream from "@/images/emojis/stream.png"
...
import streampay from "@/images/avatars/streampay.jpg"
...
const returnRandomUser = () => {
  ...
  const BoxProfileUser = {
    name: randUser.name,
    description: `Hello I'm ${firstName} and this is my StreamPayment link.`,
  ...
  return (
    <>
      <div className={styles.header}>
        ...
        <h1 className={styles.heading}>Welcome to StreamPayment™: Transforming Crypto Transactions</h1>
        <p className={styles.subheading}>Simplify, Secure, and Streamline Your Crypto Payments Experience</p>
        <form onSubmit={(e) => {
          e.preventDefault()
          setModal(true)
        }}>
      ...
      <div className={styles.gradientContainer}>
        ...
        <div className={styles.fixedBox}>
          <div className={styles.pubKeyBox}>
            <img className={styles.pubKeyEmoji} src={wallet.src} alt="" />
            <p>Strm8ose....unHPbYGX</p>
          </div>
          {defaultUser && (
            <PaymentBox user={defaultUser} dummy={true} price={Number(price)}>
              <div className={styles.linkBox}>
              <Image src={lock} alt="" />
              <p>streampayment.app/{defaultUser.link}</p>
              </div>
            </PaymentBox>
          )}
        </div>
...
export const SecondOveriewSection = () => (
  <>
          ...
          <div style={{ marginTop: '1rem' }}>
            {transactionsDefault.map((transaction, index) => (
              <div className={styles.transactionsGrid} key={index}>
                <p>streampayment.app/{transaction.link}</p>
    ...
    <div className={styles.header}>
      <Image src={hands} alt="" />
      <h1 className={styles.heading}>Empower Your Links with StreamPayment™ Dashboard</h1>
      <p className={styles.subheading}>Effortlessly Create, Track, and Analyze Your Custom Links</p>
    </div>
  </>
)
...
export const ThirdOveriewSection = ({ price }: { price: string }) => {
  ...
  return (
    ...
    <div className={styles.header}>
      ...
      <p className={styles.subheading}>Make StreamPayment app your own by customizing the profile picture, name or background of your link</p>
    </div>
    <div className={styles.gradientContainer}>
