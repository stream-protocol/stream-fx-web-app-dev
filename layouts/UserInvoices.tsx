...
import streamTokenIcon from '@/images/icons/stream_token.svg'
    ...
    <div className={defaults.paddedContainer}>
      <div className={defaults.spaceBetweenFlex}>
        <div>
          ...
          <p className={dashStyles.dashboardSubHeading}>Effortlessly Bill Anyone, Anywhere with StreamPayment™</p>
        </div>
