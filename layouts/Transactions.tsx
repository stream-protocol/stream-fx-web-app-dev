...
import stream-token from "@/images/icons/stream-token.png";
                ...
                {link && (
                  <div className={defaults.spaceBetweenFlex}>
                    ...
                    <div className={defaults.spaceBetweenFlex} style={{ flexDirection: 'column', alignItems: 'flex-start', paddingLeft: '2rem', height: '90%' }}>
                      ...
                      <p style={{ marginTop: '0.5rem' }} className={styles.transactionLightText}>streampayment.app/{transaction.link}</p>
                    </div>
                  </div>
                )}
