...
export const InvoiceComponent = ({ invoice, link, price, dummy }: InvoiceTypes) => {
  ...
  const copyLink = () => {
    navigator.clipboard.writeText(`https://streampayment.app/invoice/${invoice.invoiceNumber}`)
      ...
      <div className={styles.invoiceComponentBox}>
            ...
            <div>
              ...
              <div className={styles.invoiceProfile}>
                ...
                <div className={styles.profileText}>
                  ...
                  <p className={styles.darkGrayText}>streampayment.app/{link.link}</p>
                </div>
              </div>
            </div>
        ...
        <div className={styles.invoicePaymentBox}>
          ...
          {/* <div className={styles.componentSpaceBetweenFlex} style={{ marginTop: '1.5rem' }}>
            <p onClick={() => copyLink()} className={styles.invoiceLink}>streampayment.app/invoice/{invoice.invoiceNumber}</p>
          </div> */}
        </div>
